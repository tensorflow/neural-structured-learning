...
flags.DEFINE_boolean('save_best_val', False, 'Whether to save best val acc epoch or last epoch')
flags.DEFINE_boolean('learn_eps', False, 'Whether to learn the epsilon weighting for the nodes')
