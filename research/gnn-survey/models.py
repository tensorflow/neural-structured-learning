  ...
  def __init__(self, hidden_dim, dropout_rate, num_heads, sparse, **kwargs):
    ...
    if sparse:
      self._graph_attn_layer = [
          SparseGraphAttnLayer(self.hidden_dim, self.dropout_rate)
...
class GINBlock(tf.keras.layers.Layer):
  ...
  def __init__(self, mlp_layers, hidden_dim, dropout_rate, learn_eps, sparse,
               **kwargs):
...
class GIN(tf.keras.Model):
  ...
  def __init__(self, num_layers, mlp_layers, hidden_dim, num_classes,
               dropout_rate, learn_eps, sparse, **kwargs):
